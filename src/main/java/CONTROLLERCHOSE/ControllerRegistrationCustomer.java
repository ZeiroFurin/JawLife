...
public class ControllerRegistrationCustomer implements Initializable {
    ...
    private void register(ActionEvent event) throws IOException {
        ...
        Parent loginPage = FXMLLoader.load(getClass().getResource("LoginCustomer.fxml"));
        Scene scene = new Scene(loginPage);

        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.setTitle("Login Page Trainer"); // Ubah judul
        stage.show();
    }
    @FXML
